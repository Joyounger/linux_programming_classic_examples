...
float bessj(int n,float x)
{
	...
	extern float bessj0(float ),bessj1(float);
...
float bessk(int n,float x)
{
	...
	extern float bessk0(float),bessk1(float );
	

	if (n < 2) 
        {
        printf("Index n less than 2 in BESSK\n");
        printf("...now exiting to system...\n");
        exit(1);
        }
	tox=2.0/x;
